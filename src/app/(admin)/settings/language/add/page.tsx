...
const hasChanges = useMemo(() => {
    ...
    return (
        form.name !== init.name ||
        form.native_name !== init.native_name ||
        form.iso_code !== init.iso_code
    );
}, [form]);
...
//         form.native_name !== initialFormState.native_name ||
//         form.iso_code !== initialFormState.iso_code
//     );
// }, [form, initialFormState]);

// const hasChanges =
//     form.name !== initialForm.name ||
//     form.native_name !== initialForm.native_name ||
//     form.iso_code !== initialForm.iso_code;
...
//     JSON.stringify(form) !== JSON.stringify(initialForm);
    ...
    setForm((prev) => ({
        ...prev,
        [name as keyof LanguageForm]: value,
    }));
};
    ...
    const handleSave = async () => {
        try {
            ...
            await axios.post(
                `${API_URL}/api/language/add-language`,
                {
                    name: form.name.trim(),
                    native_name:
                        form.native_name.trim(),
